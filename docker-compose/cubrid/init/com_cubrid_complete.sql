-- CUBRID용 COM SQL (com_cubrid.sql)
-- MySQL에서 CUBRID로 변환
...
-- FK 추가
ALTER TABLE COMTCCMMNCODE ADD CONSTRAINT COMTCCMMNCODE_FK1 FOREIGN KEY (CL_CODE) REFERENCES COMTCCMMNCLCODE(CL_CODE);

-- COMTCCMMNDETAILCODE (FK 나중에 추가)
...
-- FK 추가
ALTER TABLE COMTCCMMNDETAILCODE ADD CONSTRAINT COMTCCMMNDETAILCODE_FK1 FOREIGN KEY (CODE_ID) REFERENCES COMTCCMMNCODE(CODE_ID);

-- COMTNAUTHORGROUPINFO
CREATE TABLE COMTNAUTHORGROUPINFO (
    GROUP_ID              CHAR(20) NOT NULL COMMENT '그룹ID',
    GROUP_NM              VARCHAR(60) NOT NULL COMMENT '그룹명',
    GROUP_CREAT_DE        CHAR(20) NOT NULL COMMENT '그룹생성일',
    GROUP_DC              VARCHAR(100) NULL COMMENT '그룹설명',
...
CREATE TABLE COMTNAUTHORINFO (
    ...
    AUTHOR_DC             VARCHAR(200) NULL COMMENT '권한설명',
...
CREATE TABLE COMTNROLEINFO (
    ...
    ROLE_PTTRN            VARCHAR(300) NULL COMMENT '롤패턴',
    ROLE_DC               VARCHAR(200) NULL COMMENT '롤설명',
    ROLE_TY               VARCHAR(80) NULL COMMENT '롤유형',
    ROLE_SORT             VARCHAR(10) NULL COMMENT '롤정렬',
...
-- COMTNAUTHORROLERELATE (FK 나중에 추가)
CREATE TABLE COMTNAUTHORROLERELATE (
    AUTHOR_CODE           VARCHAR(30) NOT NULL COMMENT '권한코드',
    ROLE_CODE             VARCHAR(50) NOT NULL COMMENT '롤코드',
    CREAT_DT              DATETIME NULL COMMENT '생성일',
...
-- FK 추가
ALTER TABLE COMTNAUTHORROLERELATE ADD CONSTRAINT COMTNAUTHORROLERELATE_FK1 FOREIGN KEY (AUTHOR_CODE) REFERENCES COMTNAUTHORINFO(AUTHOR_CODE) ON DELETE CASCADE;
ALTER TABLE COMTNAUTHORROLERELATE ADD CONSTRAINT COMTNAUTHORROLERELATE_FK2 FOREIGN KEY (ROLE_CODE) REFERENCES COMTNROLEINFO(ROLE_CODE) ON DELETE CASCADE;

-- COMTNBBSMASTER
CREATE TABLE COMTNBBSMASTER (
    BBS_ID                CHAR(30) NOT NULL COMMENT '게시판ID',
    BBS_NM                VARCHAR(255) NOT NULL COMMENT '게시판명',
    BBS_INTRCN            VARCHAR(2400) NULL COMMENT '게시판소개',
    BBS_TY_CODE           CHAR(6) NOT NULL COMMENT '게시판유형코드',
    REPLY_POSBL_AT        CHAR(1) NULL COMMENT '답장가능여부',
    FILE_ATCH_POSBL_AT    CHAR(1) NOT NULL COMMENT '파일첨부가능여부',
    ATCH_POSBLE_FILE_NUMBER NUMERIC(2) NOT NULL,
    ATCH_POSBLE_FILE_SIZE NUMERIC(8) NULL,
    USE_AT                CHAR(1) NOT NULL COMMENT '사용여부',
    TMPLAT_ID             CHAR(20) NULL COMMENT '템플릿ID',
...
CREATE TABLE COMTNBBS (
    NTT_ID                NUMERIC(20) NOT NULL COMMENT '게시물ID',
    BBS_ID                CHAR(30) NOT NULL COMMENT '게시판ID',
    NTT_NO                NUMERIC(20) NULL COMMENT '게시물번호',
    NTT_SJ                VARCHAR(2000) NULL COMMENT '게시물제목',
    NTT_CN               VARCHAR(32000) NULL COMMENT '게시물내용',
    ANSWER_AT             CHAR(1) NULL COMMENT '답글여부',
    PARNTSCTT_NO          NUMERIC(10) NULL COMMENT '부모글번호',
    ANSWER_LC             NUMERIC(8) NULL COMMENT '답글위치',
    SORT_ORDR             NUMERIC(8) NULL COMMENT '정렬순서',
    RDCNT                 NUMERIC(10) NULL COMMENT '조회수',
    USE_AT                CHAR(1) NOT NULL COMMENT '사용여부',
    NTCE_BGNDE            CHAR(20) NULL COMMENT '게시시작일',
    NTCE_ENDDE            CHAR(20) NULL COMMENT '게시종료일',
    NTCR_ID               VARCHAR(20) NULL COMMENT '게시자ID',
    NTCR_NM               VARCHAR(20) NULL COMMENT '게시자명',
    PASSWORD              VARCHAR(200) NULL COMMENT '비밀번호',
    ATCH_FILE_ID          CHAR(20) NULL COMMENT '첨부파일ID',
...
-- FK 추가
ALTER TABLE COMTNBBS ADD CONSTRAINT COMTNBBS_FK1 FOREIGN KEY (BBS_ID) REFERENCES COMTNBBSMASTER(BBS_ID);
...
CREATE TABLE COMTNBBSSYNCLOG (
    SYNC_ID               CHAR(20) NOT NULL COMMENT '싱크ID',
...
CREATE TABLE COMTNBLOG (
    BLOG_ID               CHAR(20) NOT NULL COMMENT '블로그ID',
    BLOG_NM               VARCHAR(255) NOT NULL COMMENT '블로그명',
    BLOG_INTRCN           VARCHAR(2400) NULL COMMENT '블로그소개',
    USE_AT                CHAR(1) NOT NULL COMMENT '사용여부',
    REGIST_SE_CODE        CHAR(6) NULL COMMENT '등록구분코드',
    TMPLAT_ID             CHAR(20) NULL COMMENT '템플릿ID',
    FRST_REGIST_PNTTM     DATETIME NOT NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NOT NULL COMMENT '최초등록자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
...
-- COMTNBLOGUSER (FK 나중에 추가)
CREATE TABLE COMTNBLOGUSER (
    BLOG_ID               CHAR(20) NOT NULL COMMENT '블로그ID',
    EMPLYR_ID             VARCHAR(20) NOT NULL COMMENT '업무사용자ID',
    MNGR_AT               CHAR(1) NOT NULL COMMENT '관리자여부',
    MBER_STTUS            VARCHAR(15) NULL COMMENT '회원상태',
    SBSCRB_DE             DATETIME NULL COMMENT '가입일',
    SECSN_DE              CHAR(20) NULL COMMENT '탈퇴일',
    USE_AT                CHAR(1) NULL COMMENT '사용여부',
    FRST_REGIST_PNTTM     DATETIME NOT NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NOT NULL COMMENT '최초등록자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
...
-- FK 추가
ALTER TABLE COMTNBLOGUSER ADD CONSTRAINT COMTNBLOGUSER_FK1 FOREIGN KEY (BLOG_ID) REFERENCES COMTNBLOG(BLOG_ID);

-- COMTNCMMNTY
CREATE TABLE COMTNCMMNTY (
    CMMNTY_ID             CHAR(20) NOT NULL COMMENT '커뮤니티ID',
    CMMNTY_NM             VARCHAR(255) NOT NULL COMMENT '커뮤니티명',
    CMMNTY_INTRCN         VARCHAR(2400) NULL COMMENT '커뮤니티소개',
    USE_AT                CHAR(1) NOT NULL COMMENT '사용여부',
    REGIST_SE_CODE        CHAR(6) NULL COMMENT '등록구분코드',
    TMPLAT_ID             CHAR(20) NULL COMMENT '템플릿ID',
    FRST_REGIST_PNTTM     DATETIME NOT NULL COMMENT '최초등록시점',
...
-- FK 추가
ALTER TABLE COMTNCMMNTYUSER ADD CONSTRAINT COMTNCMMNTYUSER_FK1 FOREIGN KEY (CMMNTY_ID) REFERENCES COMTNCMMNTY(CMMNTY_ID);

-- COMTNCOMMENT (FK 나중에 추가)
CREATE TABLE COMTNCOMMENT (
    NTT_ID                NUMERIC(20) NOT NULL COMMENT '게시물ID',
    BBS_ID                CHAR(30) NOT NULL COMMENT '게시판ID',
    ANSWER_NO             NUMERIC(20) NOT NULL COMMENT '댓글번호',
    WRTER_ID              VARCHAR(20) NULL COMMENT '작성자ID',
    WRTER_NM              VARCHAR(20) NULL COMMENT '작성자명',
    ANSWER                VARCHAR(200) NULL COMMENT '댓글',
    USE_AT                CHAR(1) NOT NULL COMMENT '사용여부',
    FRST_REGIST_PNTTM     DATETIME NOT NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NOT NULL COMMENT '최초등록자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
...
-- FK 추가
ALTER TABLE COMTNCOMMENT ADD CONSTRAINT COMTNCOMMENT_FK1 FOREIGN KEY (NTT_ID, BBS_ID) REFERENCES COMTNBBS(NTT_ID, BBS_ID);

-- COMTNEMPLYRINFO (FK 나중에 추가)
CREATE TABLE COMTNEMPLYRINFO (
    EMPLYR_ID             VARCHAR(20) NOT NULL COMMENT '업무사용자ID',
    ORGNZT_ID             CHAR(20) NULL COMMENT '조직ID',
    USER_NM               VARCHAR(60) NOT NULL COMMENT '사용자명',
    PASSWORD              VARCHAR(200) NOT NULL COMMENT '비밀번호',
    EMPL_NO               VARCHAR(20) NULL COMMENT '사원번호',
    IHIDNUM               VARCHAR(200) NULL COMMENT '주민등록번호',
    SEXDSTN_CODE          CHAR(1) NULL COMMENT '성별코드',
    BRTHDY                CHAR(20) NULL COMMENT '생일',
    FXNUM                 VARCHAR(20) NULL COMMENT '팩스번호',
    HOUSE_ADRES           VARCHAR(100) NOT NULL COMMENT '자택주소',
    PASSWORD_HINT         VARCHAR(100) NOT NULL COMMENT '비밀번호힌트',
    PASSWORD_CNSR         VARCHAR(100) NOT NULL COMMENT '비밀번호정답',
    HOUSE_END_TELNO       VARCHAR(4) NOT NULL COMMENT '자택끝전화번호',
    AREA_NO               VARCHAR(4) NOT NULL COMMENT '지역번호',
    DETAIL_ADRES          VARCHAR(100) NULL COMMENT '상세주소',
    ZIP                   VARCHAR(6) NOT NULL COMMENT '우편번호',
    OFFM_TELNO            VARCHAR(20) NULL COMMENT '사무실전화번호',
    MBTLNUM               VARCHAR(20) NULL COMMENT '이동전화번호',
    EMAIL_ADRES           VARCHAR(50) NULL COMMENT '이메일주소',
    OFCPS_NM              VARCHAR(60) NULL COMMENT '직위명',
    HOUSE_MIDDLE_TELNO    VARCHAR(4) NOT NULL COMMENT '자택중간전화번호',
    GROUP_ID              CHAR(20) NULL COMMENT '그룹ID',
    PSTINST_CODE          CHAR(8) NULL COMMENT '소속기관코드',
    EMPLYR_STTUS_CODE     CHAR(1) NOT NULL COMMENT '사용자상태코드',
    ESNTL_ID              CHAR(20) NOT NULL COMMENT '고유ID',
    CRTFC_DN_VALUE        VARCHAR(100) NULL COMMENT '인증DN값',
    SBSCRB_DE             DATETIME NULL COMMENT '가입일',
    LOCK_AT               CHAR(1) NULL COMMENT '잠금여부',
    LOCK_CNT              NUMERIC(3) NULL COMMENT '잠금회수',
    LOCK_LAST_PNTTM       DATETIME NULL COMMENT '잠금일자',
    CHG_PWD_LAST_PNTTM    DATETIME NULL COMMENT '비밀번호변경일자',
...
-- FK 추가 (GROUP_ID에 FK)
ALTER TABLE COMTNEMPLYRINFO ADD CONSTRAINT COMTNEMPLYRINFO_FK1 FOREIGN KEY (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID) ON DELETE SET NULL;

-- COMTNEMPLYRSCRTYESTBS
CREATE TABLE COMTNEMPLYRSCRTYESTBS (
    SCRTY_DTRMN_TRGET_ID  VARCHAR(20) NOT NULL COMMENT '보안결정대상ID',
    MBER_TY_CODE          CHAR(5) NULL COMMENT '회원유형코드',
    AUTHOR_CODE           VARCHAR(30) NOT NULL COMMENT '권한코드',
...
-- COMTNENTRPRSMBER (FK 나중에 추가)
CREATE TABLE COMTNENTRPRSMBER (
    ENTRPRS_MBER_ID       VARCHAR(20) NOT NULL COMMENT '기업회원ID',
    ENTRPRS_SE_CODE       CHAR(8) NULL COMMENT '기업구분코드',
    BIZRNO                VARCHAR(10) NULL COMMENT '사업자등록번호',
    JURIRNO               VARCHAR(13) NULL COMMENT '법인등록번호',
    CMPNY_NM              VARCHAR(60) NOT NULL COMMENT '회사명',
    CXFC                  VARCHAR(50) NULL COMMENT '대표이사',
    ZIP                   VARCHAR(6) NOT NULL COMMENT '우편번호',
    ADRES                 VARCHAR(100) NOT NULL COMMENT '주소',
    ENTRPRS_MIDDLE_TELNO  VARCHAR(4) NOT NULL COMMENT '기업중간전화번호',
    FXNUM                 VARCHAR(20) NULL COMMENT '팩스번호',
    INDUTY_CODE           CHAR(1) NULL COMMENT '업종코드',
    APPLCNT_NM            VARCHAR(50) NOT NULL COMMENT '신청자명',
    APPLCNT_IHIDNUM       VARCHAR(200) NULL COMMENT '신청자주민등록번호',
    SBSCRB_DE             DATETIME NULL COMMENT '가입일',
    ENTRPRS_MBER_STTUS    VARCHAR(15) NULL COMMENT '기업회원상태',
    ENTRPRS_MBER_PASSWORD  VARCHAR(200) NULL COMMENT '기업회원비밀번호',
...
-- FK 추가
ALTER TABLE COMTNENTRPRSMBER ADD CONSTRAINT COMTNENTRPRSMBER_FK1 FOREIGN KEY (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID) ON DELETE SET NULL;

-- COMTNGNRLMBER (FK 나중에 추가)
CREATE TABLE COMTNGNRLMBER (
    MBER_ID               VARCHAR(20) NOT NULL COMMENT '회원ID',
    PASSWORD              VARCHAR(200) NOT NULL COMMENT '비밀번호',
    PASSWORD_HINT         VARCHAR(100) NULL COMMENT '비밀번호힌트',
    PASSWORD_CNSR         VARCHAR(100) NULL COMMENT '비밀번호정답',
    IHIDNUM               VARCHAR(200) NULL COMMENT '주민등록번호',
    ...
    MBER_STTUS            VARCHAR(15) NULL COMMENT '회원상태',
    DETAIL_ADRES          VARCHAR(100) NULL COMMENT '상세주소',
    END_TELNO             VARCHAR(4) NOT NULL COMMENT '끝전화번호',
    MBTLNUM               VARCHAR(20) NOT NULL COMMENT '이동전화번호',
    GROUP_ID              CHAR(20) NULL COMMENT '그룹ID',
    MBER_FXNUM            VARCHAR(20) NULL COMMENT '회원팩스번호',
    MBER_EMAIL_ADRES      VARCHAR(50) NULL COMMENT '회원이메일주소',
    MIDDLE_TELNO          VARCHAR(4) NOT NULL COMMENT '중간전화번호',
    SBSCRB_DE             DATETIME NULL COMMENT '가입일',
    SEXDSTN_CODE          CHAR(1) NULL COMMENT '성별코드',
    ESNTL_ID              CHAR(20) NOT NULL COMMENT '고유ID',
    LOCK_AT               CHAR(1) NULL COMMENT '잠금여부',
...
-- FK 추가
ALTER TABLE COMTNGNRLMBER ADD CONSTRAINT COMTNGNRLMBER_FK1 FOREIGN KEY (GROUP_ID) REFERENCES COMTNAUTHORGROUPINFO(GROUP_ID) ON DELETE SET NULL;

-- COMVNUSERMASTER (VIEW → VCLASS)
CREATE VCLASS COMVNUSERMASTER (ESNTL_ID, USER_ID, PASSWORD, USER_NM, USER_ZIP, USER_ADRES, USER_EMAIL, GROUP_ID, USER_SE, ORGNZT_ID)
AS
SELECT ESNTL_ID, MBER_ID, PASSWORD, MBER_NM, ZIP, ADRES, MBER_EMAIL_ADRES, ' ', 'GNR' AS USER_SE, ' ' AS ORGNZT_ID
FROM COMTNGNRLMBER
UNION ALL
SELECT ESNTL_ID, EMPLYR_ID, PASSWORD, USER_NM, ZIP, HOUSE_ADRES, EMAIL_ADRES, GROUP_ID, 'USR' AS USER_SE, ORGNZT_ID
FROM COMTNEMPLYRINFO
UNION ALL
SELECT ESNTL_ID, ENTRPRS_MBER_ID, ENTRPRS_MBER_PASSWORD, CMPNY_NM, ZIP, ADRES, APPLCNT_EMAIL_ADRES, ' ', 'ENT' AS USER_SE, ' ' AS ORGNZT_ID
...
-- COMTNFILEDETAIL (FK 나중에 추가)
CREATE TABLE COMTNFILEDETAIL (
    ATCH_FILE_ID          CHAR(20) NOT NULL COMMENT '첨부파일ID',
    FILE_SN               NUMERIC(10) NOT NULL COMMENT '파일순번',
    FILE_STRE_COURS       VARCHAR(2000) NOT NULL COMMENT '파일저장경로',
    STRE_FILE_NM          VARCHAR(255) NOT NULL COMMENT '저장파일명',
    ORIGNL_FILE_NM        VARCHAR(255) NULL COMMENT '원파일명',
    FILE_EXTSN            VARCHAR(20) NOT NULL COMMENT '파일확장자',
    FILE_CN               VARCHAR(32000) NULL COMMENT '파일내용',
    FILE_SIZE             NUMERIC(8) NULL COMMENT '파일사이즈',
...
-- FK 추가
ALTER TABLE COMTNFILEDETAIL ADD CONSTRAINT COMTNFILEDETAIL_FK1 FOREIGN KEY (ATCH_FILE_ID) REFERENCES COMTNFILE(ATCH_FILE_ID);

-- COMTNMENUCREATDTLS (FK 나중에 추가)
CREATE TABLE COMTNMENUCREATDTLS (
    MENU_NO               NUMERIC(20) NOT NULL COMMENT '메뉴번호',
    AUTHOR_CODE           VARCHAR(30) NOT NULL COMMENT '권한코드',
    MAPNG_CREAT_ID        VARCHAR(30) NULL COMMENT '맵생성ID',
...
-- FK 추가
ALTER TABLE COMTNMENUCREATDTLS ADD CONSTRAINT COMTNMENUCREATDTLS_FK1 FOREIGN KEY (AUTHOR_CODE) REFERENCES COMTNAUTHORINFO(AUTHOR_CODE);

-- COMTNQUSTNRTMPLAT
CREATE TABLE COMTNQUSTNRTMPLAT (
    QUSTNR_TMPLAT_ID      CHAR(20) NOT NULL COMMENT '설문템플릿ID',
    QUSTNR_TMPLAT_TY      VARCHAR(100) NULL COMMENT '설문템플릿유형',
    QUSTNR_TMPLAT_DC      VARCHAR(2000) NULL COMMENT '설문템플릿설명',
    QUSTNR_TMPLAT_PATH_NM VARCHAR(100) NULL COMMENT '설문템플릿경로명',
    FRST_REGIST_PNTTM     DATETIME NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NULL COMMENT '최초등록자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
    LAST_UPDUSR_ID        VARCHAR(20) NULL COMMENT '최종수정자ID',
    QUSTNR_TMPLAT_IMAGE_INFO BLOB NULL COMMENT '설문템플릿이미지정보',
    PRIMARY KEY (QUSTNR_TMPLAT_ID)
);

CREATE UNIQUE INDEX COMTNQUSTNRTMPLAT_PK ON COMTNQUSTNRTMPLAT (QUSTNR_TMPLAT_ID);

-- COMTNQESTNRINFO (FK 나중에 추가)
CREATE TABLE COMTNQESTNRINFO (
    QUSTNR_TMPLAT_ID      CHAR(20) NOT NULL COMMENT '설문템플릿ID',
    QESTNR_ID             CHAR(20) NOT NULL COMMENT '설문지ID',
    QUSTNR_SJ             VARCHAR(255) NULL COMMENT '설문제목',
    QUSTNR_PURPS          VARCHAR(1000) NULL COMMENT '설문목적',
    QUSTNR_WRITNG_GUIDANCE_CN VARCHAR(2000) NULL COMMENT '설문작성안내내용',
    QUSTNR_TRGET          VARCHAR(1000) NULL COMMENT '설문대상',
    QUSTNR_BGNDE          CHAR(20) NULL COMMENT '설문시작일',
    QUSTNR_ENDDE          CHAR(20) NULL COMMENT '설문종료일',
    FRST_REGIST_PNTTM     DATETIME NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NULL COMMENT '최초등록자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
    LAST_UPDUSR_ID        VARCHAR(20) NULL COMMENT '최종수정자ID',
...
-- FK 추가
ALTER TABLE COMTNQESTNRINFO ADD CONSTRAINT COMTNQESTNRINFO_FK1 FOREIGN KEY (QUSTNR_TMPLAT_ID) REFERENCES COMTNQUSTNRTMPLAT(QUSTNR_TMPLAT_ID);

-- COMTNQUSTNRQESITM (FK 나중에 추가)
CREATE TABLE COMTNQUSTNRQESITM (
    QESTNR_ID             CHAR(20) NOT NULL COMMENT '설문지ID',
    QUSTNR_QESITM_ID      CHAR(20) NOT NULL COMMENT '설문문항ID',
    QUSTNR_TMPLAT_ID      CHAR(20) NOT NULL COMMENT '설문템플릿ID',
    QESTN_SN              NUMERIC(10) NULL COMMENT '질문순번',
    QESTN_TY_CODE         CHAR(1) NULL COMMENT '질문유형코드',
    QESTN_CN              VARCHAR(2500) NULL COMMENT '질문내용',
    MXMM_CHOISE_CO        NUMERIC(5) NULL COMMENT '최대선택수',
    FRST_REGIST_PNTTM     DATETIME NOT NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NOT NULL COMMENT '최초등록자ID',
...
-- FK 추가
ALTER TABLE COMTNQUSTNRQESITM ADD CONSTRAINT COMTNQUSTNRQESITM_FK1 FOREIGN KEY (QUSTNR_TMPLAT_ID, QESTNR_ID) REFERENCES COMTNQESTNRINFO(QUSTNR_TMPLAT_ID, QESTNR_ID);

-- COMTNQUSTNRIEM (FK 나중에 추가)
CREATE TABLE COMTNQUSTNRIEM (
    QUSTNR_TMPLAT_ID      CHAR(20) NOT NULL COMMENT '설문템플릿ID',
    QESTNR_ID             CHAR(20) NOT NULL COMMENT '설문지ID',
    QUSTNR_QESITM_ID      CHAR(20) NOT NULL COMMENT '설문문항ID',
    QUSTNR_IEM_ID         VARCHAR(20) NOT NULL COMMENT '설문항목ID',
    IEM_SN                NUMERIC(5) NULL COMMENT '항목순번',
    IEM_CN                VARCHAR(1000) NULL COMMENT '항목내용',
    ETC_ANSWER_AT         CHAR(1) NULL COMMENT '기타답변여부',
    FRST_REGIST_PNTTM     DATETIME NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NULL COMMENT '최초등록자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
    LAST_UPDUSR_ID        VARCHAR(20) NULL COMMENT '최종수정자ID',
...
-- FK 추가
ALTER TABLE COMTNQUSTNRIEM ADD CONSTRAINT COMTNQUSTNRIEM_FK1 FOREIGN KEY (QESTNR_ID, QUSTNR_QESITM_ID, QUSTNR_TMPLAT_ID) REFERENCES COMTNQUSTNRQESITM(QESTNR_ID, QUSTNR_QESITM_ID, QUSTNR_TMPLAT_ID);

-- COMTNQUSTNRRESPONDINFO (FK 나중에 추가)
CREATE TABLE COMTNQUSTNRRESPONDINFO (
    QUSTNR_TMPLAT_ID      CHAR(20) NOT NULL COMMENT '설문템플릿ID',
    QESTNR_ID             CHAR(20) NOT NULL COMMENT '설문지ID',
    QUSTNR_RESPOND_ID     CHAR(20) NOT NULL COMMENT '설문응답자ID',
    SEXDSTN_CODE          CHAR(1) NULL COMMENT '성별코드',
    OCCP_TY_CODE          CHAR(1) NULL COMMENT '직업유형코드',
    RESPOND_NM            VARCHAR(50) NULL COMMENT '응답자명',
    BRTHDY                CHAR(20) NULL COMMENT '생일',
    AREA_NO               VARCHAR(4) NULL COMMENT '지역번호',
    MIDDLE_TELNO          VARCHAR(4) NULL COMMENT '중간전화번호',
    END_TELNO             VARCHAR(4) NULL COMMENT '끝전화번호',
    FRST_REGIST_PNTTM     DATETIME NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NULL COMMENT '최초등록자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
    LAST_UPDUSR_ID        VARCHAR(20) NULL COMMENT '최종수정자ID',
...
-- FK 추가
ALTER TABLE COMTNQUSTNRRESPONDINFO ADD CONSTRAINT COMTNQUSTNRRESPONDINFO_FK1 FOREIGN KEY (QUSTNR_TMPLAT_ID, QESTNR_ID) REFERENCES COMTNQESTNRINFO(QUSTNR_TMPLAT_ID, QESTNR_ID);

-- COMTNQUSTNRRSPNSRESULT (FK 나중에 추가)
CREATE TABLE COMTNQUSTNRRSPNSRESULT (
    QUSTNR_RSPNS_RESULT_ID CHAR(20) NOT NULL COMMENT '설문응답결과ID',
    QESTNR_ID             CHAR(20) NOT NULL COMMENT '설문지ID',
    QUSTNR_QESITM_ID      CHAR(20) NOT NULL COMMENT '설문문항ID',
    QUSTNR_TMPLAT_ID      CHAR(20) NOT NULL COMMENT '설문템플릿ID',
    RESPOND_ANSWER_CN     VARCHAR(1000) NULL COMMENT '응답답변내용',
    ETC_ANSWER_CN         VARCHAR(1000) NULL COMMENT '기타답변내용',
    RESPOND_NM            VARCHAR(50) NULL COMMENT '응답자명',
    FRST_REGIST_PNTTM     DATETIME NULL COMMENT '최초등록시점',
    FRST_REGISTER_ID      VARCHAR(20) NULL COMMENT '최초등록자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
    LAST_UPDUSR_ID        VARCHAR(20) NULL COMMENT '최종수정자ID',
    QUSTNR_IEM_ID         VARCHAR(20) NULL COMMENT '설문항목ID',
...
-- FK 추가
ALTER TABLE COMTNQUSTNRRSPNSRESULT ADD CONSTRAINT COMTNQUSTNRRSPNSRESULT_FK1 FOREIGN KEY (QESTNR_ID, QUSTNR_QESITM_ID, QUSTNR_TMPLAT_ID) REFERENCES COMTNQUSTNRQESITM(QESTNR_ID, QUSTNR_QESITM_ID, QUSTNR_TMPLAT_ID);

-- COMTNSTSFDG
CREATE TABLE COMTNSTSFDG (
    STSFDG_NO             NUMERIC(20) NOT NULL COMMENT '만족도번호',
    NTT_ID                NUMERIC(20) NOT NULL COMMENT '게시물ID',
    BBS_ID                CHAR(30) NOT NULL COMMENT '게시판ID',
    WRTER_ID              VARCHAR(20) NULL COMMENT '작성자ID',
    WRTER_NM              VARCHAR(20) NULL COMMENT '작성자명',
    PASSWORD              VARCHAR(200) NULL COMMENT '비밀번호',
    STSFDG                NUMERIC(1) NOT NULL COMMENT '만족도',
    STSFDG_CN             VARCHAR(200) NULL COMMENT '만족도내용',
    USE_AT                CHAR(1) NOT NULL COMMENT '사용여부',
    FRST_REGIST_PNTTM     DATETIME NOT NULL COMMENT '최초등록시점',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
    FRST_REGISTER_ID      VARCHAR(20) NOT NULL COMMENT '최초등록자ID',
...
CREATE TABLE COMTNTMPLATINFO (
    ...
    TMPLAT_NM             VARCHAR(255) NULL COMMENT '템플릿명',
    TMPLAT_COURS          VARCHAR(2000) NULL COMMENT '템플릿경로',
    USE_AT                CHAR(1) NULL COMMENT '사용여부',
    TMPLAT_SE_CODE        CHAR(6) NULL COMMENT '템플릿구분코드',
    FRST_REGISTER_ID      VARCHAR(20) NULL COMMENT '최초등록자ID',
    FRST_REGIST_PNTTM     DATETIME NULL COMMENT '최초등록시점',
    LAST_UPDUSR_ID        VARCHAR(20) NULL COMMENT '최종수정자ID',
    LAST_UPDT_PNTTM       DATETIME NULL COMMENT '최종수정시점',
